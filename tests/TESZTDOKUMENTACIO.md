...
- **Termékkeresés** – keresés név, leírás és kategória alapján
- **Kosárkezelés** – termékek hozzáadása, mennyiség módosítása, törlés, összesítő
...
- **Rendelések megtekintése** – korábbi rendelések listázása és részleteinek megtekintése
...
- **Kategóriakezelés** – főkategóriák és alkategóriák létrehozása, törlése
- **Felhasználókezelés** – felhasználók listázása, admin jogosultság kezelése
